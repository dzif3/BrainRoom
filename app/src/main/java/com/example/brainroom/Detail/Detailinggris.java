...
public class Detailinggris extends AppCompatActivity {
    ...
    private void mapelData() {
        ...
        tampilData.enqueue(new Callback<ResponseModel>() {
            ...
            public void onResponse(Call<ResponseModel> call, Response<ResponseModel> response) {
                ...
                rvadapter = new AdapterDetail(Detailinggris.this, listMapel);
            ...
            public void onFailure(Call<ResponseModel> call, Throwable t) {
                Toast.makeText(Detailinggris.this, "gagal" + t.getMessage(), Toast.LENGTH_LONG).show();
            }
        });
    }
}
