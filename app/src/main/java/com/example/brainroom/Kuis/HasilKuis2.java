...
public class HasilKuis2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.hasil_kuis2);

        Button kuis = (Button) findViewById(R.id.ulang);
        kuis.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent intent = new Intent(HasilKuis2.this, KuisFisika.class);
        ...
        kuis1.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent intent = new Intent(HasilKuis2.this, MainActivity.class);
                startActivity(intent);
            }
        });
