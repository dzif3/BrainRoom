...
import com.example.brainroom.Mapel.Detail.DetailFisika;
import com.example.brainroom.Mapel.Model.DataModel;
import com.example.brainroom.R;

import java.util.List;

public class AdapterFisika extends RecyclerView.Adapter<AdapterFisika.HolderData> {
    private Context ctx;
    ...
    public void onBindViewHolder(@NonNull AdapterFisika.HolderData holder, final int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(view.getContext(), DetailFisika.class);
