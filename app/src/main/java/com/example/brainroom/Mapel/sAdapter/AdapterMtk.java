...
import com.example.brainroom.Mapel.Detail.DetailMtk;
import com.example.brainroom.Mapel.Model.DataModel;
import com.example.brainroom.R;

import java.util.List;

public class AdapterMtk extends RecyclerView.Adapter<AdapterMtk.HolderData> {
    private Context ctx;
    private List<DataModel> listmapel;



    public AdapterMtk(Context ctx, List<DataModel> listmapel) {
        this.ctx = ctx;
    ...
    @NonNull
    @Override
    public AdapterMtk.HolderData onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull AdapterMtk.HolderData holder, final int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(view.getContext(), DetailMtk.class);
