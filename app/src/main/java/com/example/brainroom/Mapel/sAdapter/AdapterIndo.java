...
public class AdapterIndo extends RecyclerView.Adapter<AdapterIndo.HolderData> {
    private Context ctx;
    private List<DataModel> listmapel;


    public AdapterIndo(Context ctx, List<DataModel> listmapel) {
        this.ctx = ctx;
    ...
    @Override
    public void onBindViewHolder(@NonNull AdapterIndo.HolderData holder, final int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(view.getContext(), DetailIndo.class);
